...
public final class Rule61 implements Converter {
    ...
    private static Node firstBuilder(final Factory factory,
        ...
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule61.CLASS_DECLARATIO);
        final List<Node> list = new LinkedList<>();
        list.add(Rule61.secondBuilder(factory, data));
        list.add(Rule61.thirdBuilder(factory, children));
    ...
    private static Node thirdBuilder(final Factory factory,
        final Map<Integer, List<Node>> children) {
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule61.CLASS_BODY);
