...
/**
 * Node that describes the 'GreaterThanOrEqualTo' type.
 *
 * @since 1.0
 */
public final class GreaterThanOrEqualTo implements RelationalExpression {
    /**
     * The type.
     */
    ...
    @Override
    public Type getType() {
        return GreaterThanOrEqualTo.TYPE;
    }
    ...
    public int getChildCount() {
        return GreaterThanOrEqualTo.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'GreaterThanOrEqualTo' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.GREATER_THAN_OR;
        }
    ...
    /**
     * Class for 'GreaterThanOrEqualTo' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(GreaterThanOrEqualTo.TYPE.getChildTypes());
        ...
        @Override
        public GreaterThanOrEqualTo createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final GreaterThanOrEqualTo node = new GreaterThanOrEqualTo();
