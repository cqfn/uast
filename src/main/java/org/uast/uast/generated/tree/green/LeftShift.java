...
/**
 * Node that describes the 'LeftShift' type.
 *
 * @since 1.0
 */
public final class LeftShift implements BitwiseExpression {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'LeftShift' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'LeftShift' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(LeftShift.TYPE.getChildTypes());
        ...
        @Override
        public LeftShift createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final LeftShift node = new LeftShift();
