 ...
 * @since 1.0
 */
public final class Rule46 implements Converter {
    /**
     * The instance.
     */
    public static final Converter INSTANCE = new Rule46();
    ...
    private static Node firstBuilder(final Factory factory,
        ...
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule46.BITWISE_AND);
        final List<Node> list = new LinkedList<>();
        list.add(Rule46.secondBuilder(factory, children));
        list.add(Rule46.fourthBuilder(factory, children));
    ...
    private static Node secondBuilder(final Factory factory,
        final Map<Integer, List<Node>> children) {
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule46.VARIABLE);
        final List<Node> list = new LinkedList<>();
        list.add(Rule46.thirdBuilder(factory, children));
        final boolean applied = builder.setChildrenList(list);
        if (applied && builder.isValid()) {
            result = builder.createNode();
        }
    ...
    private static Node thirdBuilder(final Factory factory,
        final Map<Integer, List<Node>> children) {
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule46.NAME);
    ...
    private static Node fourthBuilder(final Factory factory,
        ...
        final Builder builder = factory.createBuilder(Rule46.VARIABLE);
        final List<Node> list = new LinkedList<>();
        list.add(Rule46.fifthBuilder(factory, children));
        final boolean applied = builder.setChildrenList(list);
        if (applied && builder.isValid()) {
            result = builder.createNode();
        }
