...
/**
 * Node that describes the 'BitwiseOrAssignment' type.
 *
 * @since 1.0
 */
public final class BitwiseOrAssignment implements Assignment {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private BitwiseOrAssignment() {
    }

    @Override
    public Type getType() {
        return BitwiseOrAssignment.TYPE;
    }
    ...
    public int getChildCount() {
        return BitwiseOrAssignment.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'BitwiseOrAssignment' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.BITWISE_OR_ASSIG;
        }
    ...
    /**
     * Class for 'BitwiseOrAssignment' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(BitwiseOrAssignment.TYPE.getChildTypes());
        ...
        @Override
        public BitwiseOrAssignment createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final BitwiseOrAssignment node = new BitwiseOrAssignment();
