...
/**
 * Node that describes the 'LeftShiftAssignment' type.
 *
 * @since 1.0
 */
public final class LeftShiftAssignment implements Assignment {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private LeftShiftAssignment() {
    }

    @Override
    public Type getType() {
        return LeftShiftAssignment.TYPE;
    }
    ...
    public int getChildCount() {
        return LeftShiftAssignment.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'LeftShiftAssignment' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.LEFT_SHIFT_ASSIG;
        }
    ...
    /**
     * Class for 'LeftShiftAssignment' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(LeftShiftAssignment.TYPE.getChildTypes());
        ...
        @Override
        public LeftShiftAssignment createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final LeftShiftAssignment node = new LeftShiftAssignment();
