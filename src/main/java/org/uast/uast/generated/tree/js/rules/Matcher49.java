 ...
 * @since 1.0
 */
public final class Matcher49 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher49();
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher49.EXPECTED_TYPE)
            && node.getChildCount() == Matcher49.EXPECTED_COUNT
            && Matcher49.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher50.INSTANCE.match(
            node.getChild(Matcher49.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher51.INSTANCE.match(
            node.getChild(Matcher49.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher52.INSTANCE.match(
            node.getChild(Matcher49.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
