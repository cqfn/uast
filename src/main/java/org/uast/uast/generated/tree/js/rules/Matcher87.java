...
public final class Matcher87 implements Matcher {
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher88.INSTANCE.match(node.getChild(0), children, data);
        flag = flag && Matcher89.INSTANCE.match(node.getChild(1), children, data);
        flag = flag && Matcher90.INSTANCE.match(node.getChild(2), children, data);
        return flag;
    }
}
