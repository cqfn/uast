...
/**
 * Node that describes the 'RightShiftAssignment' type.
 *
 * @since 1.0
 */
public final class RightShiftAssignment implements Assignment {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private RightShiftAssignment() {
    }

    @Override
    public Type getType() {
        return RightShiftAssignment.TYPE;
    }
    ...
    public int getChildCount() {
        return RightShiftAssignment.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'RightShiftAssignment' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.RIGHT_SHIFT_ASSI;
        }
    ...
    /**
     * Class for 'RightShiftAssignment' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(RightShiftAssignment.TYPE.getChildTypes());
        ...
        @Override
        public RightShiftAssignment createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final RightShiftAssignment node = new RightShiftAssignment();
