...
/**
 * Node that describes the 'LogicalOr' type.
 *
 * @since 1.0
 */
public final class LogicalOr implements LogicalExpression {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'LogicalOr' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'LogicalOr' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(LogicalOr.TYPE.getChildTypes());
        ...
        @Override
        public LogicalOr createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final LogicalOr node = new LogicalOr();
