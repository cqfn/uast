...
public final class Rule132 implements Converter {
    ...
    public Node convert(final Node node, final Factory factory) {
        ...
        final boolean matched = Matcher397.INSTANCE.match(node, children, data);
        if (matched) {
            result = Rule132.firstBuilder(factory, children);
        }
        return result;
    }
    ...
    private static Node firstBuilder(final Factory factory,
        ...
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule132.STATEMENT_BLOCK);
