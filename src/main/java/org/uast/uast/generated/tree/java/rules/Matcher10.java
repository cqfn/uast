 ...
 * @since 1.0
 */
public final class Matcher10 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher10();
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher10.EXPECTED_TYPE)
            ...
            && Matcher10.EXPECTED_DATA.equals(node.getData())
            && Matcher10.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher11.INSTANCE.match(
            node.getChild(Matcher10.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher12.INSTANCE.match(
            node.getChild(Matcher10.SECOND_CHILD_ID), children, data
        );
        return flag;
    }
}
