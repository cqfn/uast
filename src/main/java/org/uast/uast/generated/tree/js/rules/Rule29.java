 ...
 * @since 1.0
 */
public final class Rule29 implements Converter {
    /**
     * The instance.
     */
    ...
    private static Node firstBuilder(final Factory factory,
        ...
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule29.NOT_EQUAL_TO);
        final List<Node> list = new LinkedList<>();
        list.add(Rule29.secondBuilder(factory, children));
        list.add(Rule29.fourthBuilder(factory, children));
    ...
    private static Node fourthBuilder(final Factory factory,
        ...
        final Builder builder = factory.createBuilder(Rule29.VARIABLE);
        final List<Node> list = new LinkedList<>();
        list.add(Rule29.fifthBuilder(factory, children));
        final boolean applied = builder.setChildrenList(list);
        if (applied && builder.isValid()) {
            result = builder.createNode();
        }
