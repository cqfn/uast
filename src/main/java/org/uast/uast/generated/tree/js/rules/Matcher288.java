 ...
 * @since 1.0
 */
public final class Matcher288 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher288();
    ...
    public boolean match(final Node node,
        ...
        if (result) {
            children.put(
                ...
                Collections.singletonList(node.getChild(Matcher288.FIRST_CHILD_ID))
            );
        }
        return result;
    }
