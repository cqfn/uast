...
/**
 * Node that describes the 'PostIncrement' type.
 *
 * @since 1.0
 */
public final class PostIncrement implements UnaryExpression {
    /**
     * The type.
     */
    ...
    public int getChildCount() {
        return PostIncrement.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'PostIncrement' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.POST_INCREMENT;
        }
    ...
    /**
     * Class for 'PostIncrement' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(PostIncrement.TYPE.getChildTypes());
        ...
        @Override
        public PostIncrement createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final PostIncrement node = new PostIncrement();
