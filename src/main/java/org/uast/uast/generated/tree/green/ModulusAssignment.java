...
/**
 * Node that describes the 'ModulusAssignment' type.
 *
 * @since 1.0
 */
public final class ModulusAssignment implements Assignment {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private ModulusAssignment() {
    }

    @Override
    public Type getType() {
        return ModulusAssignment.TYPE;
    }
    ...
    public int getChildCount() {
        return ModulusAssignment.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'ModulusAssignment' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.MODULUS_ASSIGNME;
        }
    ...
    /**
     * Class for 'ModulusAssignment' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(ModulusAssignment.TYPE.getChildTypes());
        ...
        @Override
        public ModulusAssignment createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final ModulusAssignment node = new ModulusAssignment();
