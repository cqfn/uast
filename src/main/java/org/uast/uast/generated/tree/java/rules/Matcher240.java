...
public final class Matcher240 implements Matcher {
    ...
    public boolean match(final Node node,
        ...
        final boolean result = node.belongsToGroup(Matcher240.EXPECTED_TYPE)
        ...
        if (result) {
            children.put(
                Matcher240.FIRST_HOLE_ID,
                Collections.singletonList(node.getChild(Matcher240.FIRST_CHILD_ID))
            );
            children.put(
                Matcher240.SECOND_HOLE_ID,
                Collections.singletonList(node.getChild(Matcher240.SECOND_CHILD_ID))
            );
            children.put(
                Matcher240.THIRD_HOLE_ID,
                Collections.singletonList(node.getChild(Matcher240.THIRD_CHILD_ID))
            );
            children.put(
                Matcher240.FOURTH_HOLE_ID,
                Collections.singletonList(node.getChild(Matcher240.FOURTH_CHILD_ID))
            );
        }
        return result;
    }
