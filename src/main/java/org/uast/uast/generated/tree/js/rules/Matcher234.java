 ...
 * @since 1.0
 */
public final class Matcher234 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher234();
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher234.EXPECTED_TYPE)
            && node.getChildCount() == Matcher234.EXPECTED_COUNT
            && Matcher234.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher235.INSTANCE.match(
            node.getChild(Matcher234.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher236.INSTANCE.match(
            node.getChild(Matcher234.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher237.INSTANCE.match(
            node.getChild(Matcher234.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
