...
public final class Matcher170 implements Matcher {
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher170.EXPECTED_TYPE)
            ...
            && Matcher170.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher171.INSTANCE.match(node.getChild(0), children, data);
        flag = flag && Matcher172.INSTANCE.match(node.getChild(1), children, data);
        flag = flag && Matcher174.INSTANCE.match(node.getChild(2), children, data);
        return flag;
    }
}
