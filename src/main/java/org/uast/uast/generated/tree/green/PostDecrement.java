...
/**
 * Node that describes the 'PostDecrement' type.
 *
 * @since 1.0
 */
public final class PostDecrement implements UnaryExpression {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private PostDecrement() {
    }

    @Override
    public Type getType() {
        return PostDecrement.TYPE;
    }
    ...
    public int getChildCount() {
        return PostDecrement.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'PostDecrement' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.POST_DECREMENT;
        }
    ...
    /**
     * Class for 'PostDecrement' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(PostDecrement.TYPE.getChildTypes());
        ...
        @Override
        public PostDecrement createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final PostDecrement node = new PostDecrement();
