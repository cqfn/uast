...
/**
 * Node that describes the 'BitwiseComplement' type.
 *
 * @since 1.0
 */
public final class BitwiseComplement implements BitwiseExpression {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private BitwiseComplement() {
    }

    @Override
    public Type getType() {
        return BitwiseComplement.TYPE;
    }
    ...
    public int getChildCount() {
        return BitwiseComplement.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'BitwiseComplement' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.BITWISE_COMPLEME;
        }
    ...
    /**
     * Class for 'BitwiseComplement' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(BitwiseComplement.TYPE.getChildTypes());
        ...
        @Override
        public BitwiseComplement createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final BitwiseComplement node = new BitwiseComplement();
