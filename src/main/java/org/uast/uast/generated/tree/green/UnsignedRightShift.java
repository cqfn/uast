...
/**
 * Node that describes the 'UnsignedRightShift' type.
 *
 * @since 1.0
 */
public final class UnsignedRightShift implements BitwiseExpression {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private UnsignedRightShift() {
    }

    @Override
    public Type getType() {
        return UnsignedRightShift.TYPE;
    }
    ...
    public int getChildCount() {
        return UnsignedRightShift.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'UnsignedRightShift' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        /**
         * The 'BitwiseExpression' string.
         */
        private static final String BITWISE_EXPRESSI = "BitwiseExpression";
        ...
        private static final List<String> HIERARCHY =
            Collections.unmodifiableList(
                Arrays.asList(
                    TypeImpl.UNSIGNED_RIGHT_S,
                    TypeImpl.BITWISE_EXPRESSI,
                    TypeImpl.EXPRESSION
                )
            );
        ...
        public String getName() {
            return TypeImpl.UNSIGNED_RIGHT_S;
        }
    ...
    /**
     * Class for 'UnsignedRightShift' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(UnsignedRightShift.TYPE.getChildTypes());
        ...
        @Override
        public UnsignedRightShift createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final UnsignedRightShift node = new UnsignedRightShift();
