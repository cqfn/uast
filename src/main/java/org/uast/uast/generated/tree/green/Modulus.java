...
/**
 * Node that describes the 'Modulus' type.
 *
 * @since 1.0
 */
public final class Modulus implements ArithmeticExpression {
    ...
    /**
     * Type descriptor of the 'Modulus' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'Modulus' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(Modulus.TYPE.getChildTypes());
        ...
        @Override
        public Modulus createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final Modulus node = new Modulus();
