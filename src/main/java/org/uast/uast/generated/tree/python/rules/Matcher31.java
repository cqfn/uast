...
public final class Matcher31 implements Matcher {
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher31.EXPECTED_TYPE)
            ...
            && Matcher31.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher32.INSTANCE.match(
            node.getChild(Matcher31.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher33.INSTANCE.match(
            node.getChild(Matcher31.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher34.INSTANCE.match(
            node.getChild(Matcher31.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
