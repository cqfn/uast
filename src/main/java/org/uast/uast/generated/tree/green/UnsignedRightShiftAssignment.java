...
/**
 * Node that describes the 'UnsignedRightShiftAssignment' type.
 *
 * @since 1.0
 */
public final class UnsignedRightShiftAssignment implements Assignment {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private UnsignedRightShiftAssignment() {
    }

    @Override
    public Type getType() {
        return UnsignedRightShiftAssignment.TYPE;
    }
    ...
    public int getChildCount() {
        return UnsignedRightShiftAssignment.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'UnsignedRightShiftAssignment' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'UnsignedRightShiftAssignment' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(UnsignedRightShiftAssignment.TYPE.getChildTypes());
        ...
        @Override
        public UnsignedRightShiftAssignment createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final UnsignedRightShiftAssignment node = new UnsignedRightShiftAssignment();
