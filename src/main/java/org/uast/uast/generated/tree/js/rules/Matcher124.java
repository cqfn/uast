 ...
 * @since 1.0
 */
public final class Matcher124 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher124();
    ...
    public boolean match(final Node node,
        ...
        if (result) {
            children.put(
                ...
                Collections.singletonList(node.getChild(Matcher124.FIRST_CHILD_ID))
            );
        }
        return result;
    }
