...
/**
 * Node that describes the 'BitwiseOr' type.
 *
 * @since 1.0
 */
public final class BitwiseOr implements BitwiseExpression {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'BitwiseOr' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'BitwiseOr' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(BitwiseOr.TYPE.getChildTypes());
        ...
        @Override
        public BitwiseOr createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final BitwiseOr node = new BitwiseOr();
