...
/**
 * Node that describes the 'FunctionCallExpression' type.
 *
 * @since 1.0
 */
public final class FunctionCallExpression implements Expression {
    ...
    @Override
    public Type getType() {
        return FunctionCallExpression.TYPE;
    }
    ...
    /**
     * Type descriptor of the 'FunctionCallExpression' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.FUNCTION_CALL_EX;
        }
    ...
    /**
     * Class for 'FunctionCallExpression' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper = new ChildrenMapper(FunctionCallExpression.TYPE.getChildTypes());
        ...
        @Override
        public FunctionCallExpression createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final FunctionCallExpression node = new FunctionCallExpression();
