...
/**
 * Node that describes the 'Positive' type.
 *
 * @since 1.0
 */
public final class Positive implements UnaryExpression {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'Positive' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'Positive' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(Positive.TYPE.getChildTypes());
        ...
        @Override
        public Positive createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final Positive node = new Positive();
