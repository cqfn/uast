...
/**
 * Node that describes the 'PreIncrement' type.
 *
 * @since 1.0
 */
public final class PreIncrement implements UnaryExpression {
    /**
     * The type.
     */
    ...
    public int getChildCount() {
        return PreIncrement.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'PreIncrement' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'PreIncrement' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(PreIncrement.TYPE.getChildTypes());
        ...
        @Override
        public PreIncrement createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final PreIncrement node = new PreIncrement();
