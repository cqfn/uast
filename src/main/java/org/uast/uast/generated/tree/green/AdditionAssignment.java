...
/**
 * Node that describes the 'AdditionAssignment' type.
 *
 * @since 1.0
 */
public final class AdditionAssignment implements Assignment {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private AdditionAssignment() {
    }

    @Override
    public Type getType() {
        return AdditionAssignment.TYPE;
    }
    ...
    public int getChildCount() {
        return AdditionAssignment.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'AdditionAssignment' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.ADDITION_ASSIGNM;
        }
    ...
    /**
     * Class for 'AdditionAssignment' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(AdditionAssignment.TYPE.getChildTypes());
        ...
        @Override
        public AdditionAssignment createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final AdditionAssignment node = new AdditionAssignment();
