 ...
 * @since 1.0
 */
public final class Multiplication implements ArithmeticExpression {
    /**
     * The type.
     */
    ...
    public int getChildCount() {
        return Multiplication.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'Multiplication' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.MULTIPLICATION;
        }
    ...
    /**
     * Class for 'Multiplication' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(Multiplication.TYPE.getChildTypes());
