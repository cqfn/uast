...
/**
 * Node that describes the 'LessThan' type.
 *
 * @since 1.0
 */
public final class LessThan implements RelationalExpression {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'LessThan' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'LessThan' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(LessThan.TYPE.getChildTypes());
        ...
        @Override
        public LessThan createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final LessThan node = new LessThan();
