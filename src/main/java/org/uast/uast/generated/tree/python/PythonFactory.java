...
/**
 * Factory that creates 'python' nodes.
 *
 * @since 1.0
 */
public final class PythonFactory extends Factory {
    /**
     * The instance.
     */
    public static final Factory INSTANCE = new PythonFactory();

    /**
     * Constructor.
     */
    private PythonFactory() {
        super(Collections.unmodifiableMap(PythonFactory.init()));
    }
