...
/**
 * Node that describes the 'LogicalNot' type.
 *
 * @since 1.0
 */
public final class LogicalNot implements LogicalExpression {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'LogicalNot' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'LogicalNot' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(LogicalNot.TYPE.getChildTypes());
        ...
        @Override
        public LogicalNot createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final LogicalNot node = new LogicalNot();
