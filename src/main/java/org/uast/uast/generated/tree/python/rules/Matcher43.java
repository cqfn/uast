...
public final class Matcher43 implements Matcher {
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher44.INSTANCE.match(node.getChild(0), children, data);
        flag = flag && Matcher45.INSTANCE.match(node.getChild(1), children, data);
        flag = flag && Matcher46.INSTANCE.match(node.getChild(2), children, data);
        return flag;
    }
}
