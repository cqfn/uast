 ...
 * @since 1.0
 */
public final class Matcher43 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher43();
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher43.EXPECTED_TYPE)
            ...
            && Matcher43.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher44.INSTANCE.match(
            node.getChild(Matcher43.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher45.INSTANCE.match(
            node.getChild(Matcher43.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher46.INSTANCE.match(
            node.getChild(Matcher43.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
