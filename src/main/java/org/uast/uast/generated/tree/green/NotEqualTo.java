...
/**
 * Node that describes the 'NotEqualTo' type.
 *
 * @since 1.0
 */
public final class NotEqualTo implements RelationalExpression {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'NotEqualTo' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'NotEqualTo' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(NotEqualTo.TYPE.getChildTypes());
        ...
        @Override
        public NotEqualTo createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final NotEqualTo node = new NotEqualTo();
