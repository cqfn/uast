 ...
 * @since 1.0
 */
public final class Matcher241 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher241();
    ...
    public boolean match(final Node node,
        ...
        if (result) {
            children.put(
                ...
                Collections.singletonList(node.getChild(Matcher241.FIRST_CHILD_ID))
            );
            children.put(
                Matcher241.SECOND_HOLE_ID,
                Collections.singletonList(node.getChild(Matcher241.SECOND_CHILD_ID))
            );
            children.put(
