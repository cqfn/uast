...
/**
 * Node that describes the 'ClassBody' type.
 *
 * @since 1.0
 */
public final class ClassBody implements Node {
    /**
     * The type.
     */
    ...
    /**
     * Return a child node with 'ClassItem' type by its index.
     * @param index Child index
     * @return A node
     */
    public ClassItem getClassItem(final int index) {
    ...
    /**
     * Type descriptor of the 'ClassBody' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'ClassBody' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
         ...
         * List of child nodes.
         */
        private List<ClassItem> children = Collections.emptyList();
        ...
        public boolean setChildrenList(final List<Node> list) {
            boolean result = true;
            final List<ClassItem> clarified = new ArrayList<>(list.size());
            for (final Node node : list) {
                if (node instanceof ClassItem) {
                    clarified.add((ClassItem) node);
                } else {
                    result = false;
                    break;
                }
        ...
        @Override
        public ClassBody createNode() {
            final ClassBody node = new ClassBody();
