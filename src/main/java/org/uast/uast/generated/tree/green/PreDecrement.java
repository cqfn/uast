...
/**
 * Node that describes the 'PreDecrement' type.
 *
 * @since 1.0
 */
public final class PreDecrement implements UnaryExpression {
    /**
     * The type.
     */
    ...
    public int getChildCount() {
        return PreDecrement.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'PreDecrement' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'PreDecrement' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(PreDecrement.TYPE.getChildTypes());
        ...
        @Override
        public PreDecrement createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final PreDecrement node = new PreDecrement();
