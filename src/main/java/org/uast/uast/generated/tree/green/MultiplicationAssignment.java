...
/**
 * Node that describes the 'MultiplicationAssignment' type.
 *
 * @since 1.0
 */
public final class MultiplicationAssignment implements Assignment {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private MultiplicationAssignment() {
    }

    @Override
    public Type getType() {
        return MultiplicationAssignment.TYPE;
    }
    ...
    public int getChildCount() {
        return MultiplicationAssignment.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'MultiplicationAssignment' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.MULTIPLICATION_A;
        }
    ...
    /**
     * Class for 'MultiplicationAssignment' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(MultiplicationAssignment.TYPE.getChildTypes());
        ...
        @Override
        public MultiplicationAssignment createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final MultiplicationAssignment node = new MultiplicationAssignment();
