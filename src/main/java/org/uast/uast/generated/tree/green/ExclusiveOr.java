...
/**
 * Node that describes the 'ExclusiveOr' type.
 *
 * @since 1.0
 */
public final class ExclusiveOr implements BitwiseExpression {
    /**
     * The type.
     */
    ...
    public int getChildCount() {
        return ExclusiveOr.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'ExclusiveOr' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'ExclusiveOr' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(ExclusiveOr.TYPE.getChildTypes());
        ...
        @Override
        public ExclusiveOr createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final ExclusiveOr node = new ExclusiveOr();
