...
/**
 * Node that describes the 'RightShift' type.
 *
 * @since 1.0
 */
public final class RightShift implements BitwiseExpression {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'RightShift' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'RightShift' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(RightShift.TYPE.getChildTypes());
        ...
        @Override
        public RightShift createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final RightShift node = new RightShift();
