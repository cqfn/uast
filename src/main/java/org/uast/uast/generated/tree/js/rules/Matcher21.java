...
public final class Matcher21 implements Matcher {
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher22.INSTANCE.match(node.getChild(0), children, data);
        flag = flag && Matcher23.INSTANCE.match(node.getChild(1), children, data);
        flag = flag && Matcher24.INSTANCE.match(node.getChild(2), children, data);
        return flag;
    }
}
