...
public final class Matcher9 implements Matcher {
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher10.INSTANCE.match(node.getChild(0), children, data);
        flag = flag && Matcher11.INSTANCE.match(node.getChild(1), children, data);
        flag = flag && Matcher12.INSTANCE.match(node.getChild(2), children, data);
        return flag;
    }
}
