 ...
 * @since 1.0
 */
public final class Matcher58 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher58();
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher58.EXPECTED_TYPE)
            ...
            && Matcher58.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher59.INSTANCE.match(
            node.getChild(Matcher58.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher60.INSTANCE.match(
            node.getChild(Matcher58.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher61.INSTANCE.match(
            node.getChild(Matcher58.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
