...
public final class Matcher200 implements Matcher {
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher201.INSTANCE.match(node.getChild(0), children, data);
        flag = flag && Matcher202.INSTANCE.match(node.getChild(1), children, data);
        flag = flag && Matcher203.INSTANCE.match(node.getChild(2), children, data);
        return flag;
    }
}
