...
public final class Matcher59 implements Matcher {
    ...
    public boolean match(final Node node,
        ...
        if (result) {
            ...
            children.put(
                Matcher59.THIRD_HOLE_ID,
                Collections.singletonList(node.getChild(Matcher59.THIRD_CHILD_ID))
            );
            children.put(
                Matcher59.FOURTH_HOLE_ID,
                Collections.singletonList(node.getChild(Matcher59.FOURTH_CHILD_ID))
            );
        }
        return result;
    }
