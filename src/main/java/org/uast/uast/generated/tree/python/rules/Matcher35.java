 ...
 * @since 1.0
 */
public final class Matcher35 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher35();
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher35.EXPECTED_TYPE)
            && node.getChildCount() == Matcher35.EXPECTED_COUNT
            && Matcher35.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher36.INSTANCE.match(
            node.getChild(Matcher35.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher37.INSTANCE.match(
            node.getChild(Matcher35.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher38.INSTANCE.match(
            node.getChild(Matcher35.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
