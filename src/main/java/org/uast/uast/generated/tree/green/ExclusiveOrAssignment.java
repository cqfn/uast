...
/**
 * Node that describes the 'ExclusiveOrAssignment' type.
 *
 * @since 1.0
 */
public final class ExclusiveOrAssignment implements Assignment {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private ExclusiveOrAssignment() {
    }

    @Override
    public Type getType() {
        return ExclusiveOrAssignment.TYPE;
    }
    ...
    public int getChildCount() {
        return ExclusiveOrAssignment.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'ExclusiveOrAssignment' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        /**
         * The 'ExclusiveOrAssignment' string.
         */
        private static final String EXCLUSIVE_OR_ASS = "ExclusiveOrAssignment";
        ...
        public String getName() {
            return TypeImpl.EXCLUSIVE_OR_ASS;
        }
    ...
    /**
     * Class for 'ExclusiveOrAssignment' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(ExclusiveOrAssignment.TYPE.getChildTypes());
        ...
        @Override
        public ExclusiveOrAssignment createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final ExclusiveOrAssignment node = new ExclusiveOrAssignment();
