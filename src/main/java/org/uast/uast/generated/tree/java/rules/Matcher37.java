 ...
 * @since 1.0
 */
public final class Matcher37 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher37();
    ...
    public boolean match(final Node node,
        ...
        final boolean result = node.belongsToGroup(Matcher37.EXPECTED_TYPE)
            ...
            && Matcher37.EXPECTED_DATA.equals(node.getData())
            && Matcher38.INSTANCE.match(node.getChild(0), children, data);
        if (result) {
            children.put(
