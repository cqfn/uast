 ...
 * @since 1.0
 */
public final class Rule75 implements Converter {
    /**
     * The instance.
     */
    ...
    private static Node firstBuilder(final Factory factory,
        ...
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule75.LOGICAL_AND);
        final List<Node> list = new LinkedList<>();
        list.add(Rule75.secondBuilder(factory, children));
        list.add(Rule75.fourthBuilder(factory, children));
    ...
    private static Node secondBuilder(final Factory factory,
        ...
        final List<Node> list = new LinkedList<>();
        list.add(Rule75.thirdBuilder(factory, children));
        final boolean applied = builder.setChildrenList(list);
        if (applied && builder.isValid()) {
            result = builder.createNode();
        }
    ...
    private static Node thirdBuilder(final Factory factory,
        final Map<Integer, List<Node>> children) {
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule75.NAME);
    ...
    private static Node fourthBuilder(final Factory factory,
        ...
        final Builder builder = factory.createBuilder(Rule75.VARIABLE);
        final List<Node> list = new LinkedList<>();
        list.add(Rule75.fifthBuilder(factory, children));
        final boolean applied = builder.setChildrenList(list);
        if (applied && builder.isValid()) {
            result = builder.createNode();
        }
