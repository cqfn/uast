 ...
 * @since 1.0
 */
public final class Rule92 implements Converter {
    /**
     * The instance.
     */
    ...
    public Node convert(final Node node, final Factory factory) {
        ...
        final boolean matched = Matcher284.INSTANCE.match(node, children, data);
        if (matched) {
    ...
    private static Node firstBuilder(final Factory factory,
        ...
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule92.RIGHT_SHIFT);
        final List<Node> list = new LinkedList<>();
        list.add(Rule92.secondBuilder(factory, children));
        list.addAll(children.get(Rule92.FIRST_HOLE_ID));
