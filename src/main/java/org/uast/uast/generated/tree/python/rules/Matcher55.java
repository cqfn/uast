 ...
 * @since 1.0
 */
public final class Matcher55 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher55();
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher56.INSTANCE.match(
            node.getChild(Matcher55.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher57.INSTANCE.match(
            node.getChild(Matcher55.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher58.INSTANCE.match(
            node.getChild(Matcher55.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
