...
public final class Matcher59 implements Matcher {
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher59.EXPECTED_TYPE)
            ...
            && Matcher59.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher60.INSTANCE.match(
            node.getChild(Matcher59.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher61.INSTANCE.match(
            node.getChild(Matcher59.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher62.INSTANCE.match(
            node.getChild(Matcher59.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
