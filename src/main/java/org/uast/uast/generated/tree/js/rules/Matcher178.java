 ...
 * @since 1.0
 */
public final class Matcher178 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher178();
    ...
    public boolean match(final Node node,
        ...
        final boolean result = node.belongsToGroup(Matcher178.EXPECTED_TYPE)
            ...
            && Matcher180.INSTANCE.match(node.getChild(2), children, data);
        if (result) {
            children.put(
