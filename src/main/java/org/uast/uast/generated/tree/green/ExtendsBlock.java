...
/**
 * Node that describes the 'ExtendsBlock' type.
 *
 * @since 1.0
 */
public final class ExtendsBlock implements Node {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private ExtendsBlock() {
    }

    @Override
    public Type getType() {
        return ExtendsBlock.TYPE;
    }
    ...
    /**
     * Type descriptor of the 'ExtendsBlock' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'ExtendsBlock' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        @Override
        public ExtendsBlock createNode() {
            final ExtendsBlock node = new ExtendsBlock();
