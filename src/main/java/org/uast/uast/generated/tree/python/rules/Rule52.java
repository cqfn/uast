 ...
 * @since 1.0
 */
public final class Rule52 implements Converter {
    /**
     * The instance.
     */
    public static final Converter INSTANCE = new Rule52();
    ...
    public Node convert(final Node node, final Factory factory) {
        ...
        final boolean matched = Matcher178.INSTANCE.match(node, children, data);
        if (matched) {
            result = Rule52.firstBuilder(factory, children, data);
        }
        return result;
    }
    ...
    private static Node firstBuilder(final Factory factory,
        ...
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule52.FUNCTION_DECLARA);
        final List<Node> list = new LinkedList<>();
        list.add(Rule52.secondBuilder(factory, data));
        list.add(Rule52.thirdBuilder(factory));
        list.add(Rule52.fourthBuilder(factory, children));
    ...
    private static Node secondBuilder(final Factory factory, final Map<Integer, String> data) {
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule52.IDENTIFIER);
    ...
    private static Node thirdBuilder(final Factory factory) {
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule52.PARAMETER_BLOCK);
        if (builder.isValid()) {
            result = builder.createNode();
        }
        return result;
    ...
    private static Node fourthBuilder(final Factory factory,
        final Map<Integer, List<Node>> children) {
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule52.STATEMENT_BLOCK);
