...
/**
 * Node that describes the 'SubtractionAssignment' type.
 *
 * @since 1.0
 */
public final class SubtractionAssignment implements Assignment {
    /**
     * The type.
     */
     ...
     * Constructor.
     */
    private SubtractionAssignment() {
    }

    @Override
    public Type getType() {
        return SubtractionAssignment.TYPE;
    }
    ...
    public int getChildCount() {
        return SubtractionAssignment.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'SubtractionAssignment' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.SUBTRACTION_ASSI;
        }
    ...
    /**
     * Class for 'SubtractionAssignment' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(SubtractionAssignment.TYPE.getChildTypes());
        ...
        @Override
        public SubtractionAssignment createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final SubtractionAssignment node = new SubtractionAssignment();
