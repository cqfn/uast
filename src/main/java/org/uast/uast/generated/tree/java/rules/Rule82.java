 ...
 * @since 1.0
 */
public final class Rule82 implements Converter {
    /**
     * The instance.
     */
    ...
    private static Node firstBuilder(final Factory factory,
        ...
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule82.MULTIPLICATION_A);
        final List<Node> list = new LinkedList<>();
        list.add(Rule82.secondBuilder(factory, children));
        list.addAll(children.get(Rule82.FIRST_HOLE_ID));
    ...
    private static Node secondBuilder(final Factory factory,
        final Map<Integer, List<Node>> children) {
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule82.VARIABLE);
