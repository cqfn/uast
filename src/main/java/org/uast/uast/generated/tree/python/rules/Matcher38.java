 ...
 * @since 1.0
 */
public final class Matcher38 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher38();
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher38.EXPECTED_TYPE)
            && node.getChildCount() == Matcher38.EXPECTED_COUNT
            && Matcher38.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher39.INSTANCE.match(
            node.getChild(Matcher38.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher40.INSTANCE.match(
            node.getChild(Matcher38.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher41.INSTANCE.match(
            node.getChild(Matcher38.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
