 ...
 * @since 1.0
 */
public final class Matcher214 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher214();
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher214.EXPECTED_TYPE)
            && node.getChildCount() == Matcher214.EXPECTED_COUNT
            && Matcher214.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher215.INSTANCE.match(
            node.getChild(Matcher214.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher216.INSTANCE.match(
            node.getChild(Matcher214.SECOND_CHILD_ID), children, data
        );
