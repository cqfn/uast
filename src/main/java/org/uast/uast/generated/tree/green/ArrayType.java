...
/**
 * Node that describes the 'ArrayType' type.
 *
 * @since 1.0
 */
public final class ArrayType implements TypeName {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'ArrayType' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'ArrayType' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper = new ChildrenMapper(ArrayType.TYPE.getChildTypes());
            final boolean result = mapper.map(mapping, list);
            if (result) {
                this.first = (TypeName) mapping[0];
                this.second = (DimensionList) mapping[1];
            }
            return result;
        }
        ...
        @Override
        public ArrayType createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final ArrayType node = new ArrayType();
