...
public final class Matcher13 implements Matcher {
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher13.EXPECTED_TYPE)
            ...
            && Matcher13.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher14.INSTANCE.match(
            node.getChild(Matcher13.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher15.INSTANCE.match(
            node.getChild(Matcher13.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher16.INSTANCE.match(
            node.getChild(Matcher13.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
