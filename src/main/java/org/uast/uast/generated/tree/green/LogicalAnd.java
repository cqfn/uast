...
/**
 * Node that describes the 'LogicalAnd' type.
 *
 * @since 1.0
 */
public final class LogicalAnd implements LogicalExpression {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'LogicalAnd' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        /**
         * The 'LogicalExpression' string.
         */
        private static final String LOGICAL_EXPRESSI = "LogicalExpression";
        ...
        private static final List<String> HIERARCHY =
            Collections.unmodifiableList(
                Arrays.asList(
                    TypeImpl.LOGICAL_AND,
                    TypeImpl.LOGICAL_EXPRESSI,
                    TypeImpl.EXPRESSION
                )
            );
    ...
    /**
     * Class for 'LogicalAnd' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(LogicalAnd.TYPE.getChildTypes());
        ...
        @Override
        public LogicalAnd createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final LogicalAnd node = new LogicalAnd();
