 ...
 * @since 1.0
 */
public final class Matcher25 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher25();
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher25.EXPECTED_TYPE)
            && node.getChildCount() == Matcher25.EXPECTED_COUNT
            && Matcher25.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher26.INSTANCE.match(
            node.getChild(Matcher25.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher27.INSTANCE.match(
            node.getChild(Matcher25.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher28.INSTANCE.match(
            node.getChild(Matcher25.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
