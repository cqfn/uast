...
/**
 * Node that describes the 'LessThanOrEqualTo' type.
 *
 * @since 1.0
 */
public final class LessThanOrEqualTo implements RelationalExpression {
    /**
     * The type.
     */
    ...
    public int getChildCount() {
        return LessThanOrEqualTo.CHILD_COUNT;
    }
    ...
    /**
     * Type descriptor of the 'LessThanOrEqualTo' node.
     *
     * @since 1.0
     */
    private static class TypeImpl implements Type {
        ...
        public String getName() {
            return TypeImpl.LESS_THAN_OR_EQU;
        }
    ...
    /**
     * Class for 'LessThanOrEqualTo' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(LessThanOrEqualTo.TYPE.getChildTypes());
        ...
        @Override
        public LessThanOrEqualTo createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final LessThanOrEqualTo node = new LessThanOrEqualTo();
