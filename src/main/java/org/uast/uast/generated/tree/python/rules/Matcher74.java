 ...
 * @since 1.0
 */
public final class Matcher74 implements Matcher {
    /**
     * The instance.
     */
    public static final Matcher INSTANCE = new Matcher74();
    ...
    public boolean match(final Node node,
        ...
        return node.belongsToGroup(Matcher74.EXPECTED_TYPE)
            && node.getChildCount() == Matcher74.EXPECTED_COUNT
            && Matcher74.matchChildren(node, children, data);
    }
    ...
    private static boolean matchChildren(final Node node,
        final Map<Integer, List<Node>> children,
        final Map<Integer, String> data) {
        boolean flag = Matcher75.INSTANCE.match(
            node.getChild(Matcher74.FIRST_CHILD_ID), children, data
        );
        flag = flag && Matcher76.INSTANCE.match(
            node.getChild(Matcher74.SECOND_CHILD_ID), children, data
        );
        flag = flag && Matcher77.INSTANCE.match(
            node.getChild(Matcher74.THIRD_CHILD_ID), children, data
        );
        return flag;
    }
}
