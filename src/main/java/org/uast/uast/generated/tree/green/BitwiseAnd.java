...
/**
 * Node that describes the 'BitwiseAnd' type.
 *
 * @since 1.0
 */
public final class BitwiseAnd implements BitwiseExpression {
    /**
     * The type.
     */
    ...
    /**
     * Type descriptor of the 'BitwiseAnd' node.
     *
     * @since 1.0
     */
    ...
    /**
     * Class for 'BitwiseAnd' node construction.
     *
     * @since 1.0
     */
    public static final class Constructor implements Builder {
        ...
        public boolean setChildrenList(final List<Node> list) {
            ...
            final ChildrenMapper mapper =
                new ChildrenMapper(BitwiseAnd.TYPE.getChildTypes());
        ...
        @Override
        public BitwiseAnd createNode() {
            if (!this.isValid()) {
                throw new IllegalStateException();
            }
            final BitwiseAnd node = new BitwiseAnd();
