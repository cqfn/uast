 ...
 * @since 1.0
 */
public final class Rule108 implements Converter {
    /**
     * The instance.
     */
    public static final Converter INSTANCE = new Rule108();
    ...
    public Node convert(final Node node, final Factory factory) {
        ...
        final boolean matched = Matcher186.INSTANCE.match(node, children, data);
        if (matched) {
    ...
    private static Node firstBuilder(final Factory factory,
        ...
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule108.FUNCTION_CALL);
        final List<Node> list = new LinkedList<>();
        list.addAll(children.get(Rule108.FIRST_HOLE_ID));
        list.addAll(children.get(Rule108.SECOND_HOLE_ID));
        list.add(Rule108.secondBuilder(factory, children));
    ...
    private static Node secondBuilder(final Factory factory,
        final Map<Integer, List<Node>> children) {
        Node result = EmptyTree.INSTANCE;
        final Builder builder = factory.createBuilder(Rule108.EXPRESSION_LIST);
